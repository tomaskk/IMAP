...
namespace IMAP
{
    public class ImapClient
    {
        ...
        public void ConnectToGmail()      //---#1 log in
        {
            ...
            ReceiveResponse("");
            ReceiveResponse(prefix + " LOGIN " + user + " " + pw + " \r\n");
        ...
        {
            Console.Write("Letter's UID to mark as UNSEEN? : ");
            try
            {
                index = Convert.ToInt32(Console.ReadLine());
            }
        ...
        {
            Console.Write("Letter's UID to DELETE : ");
            try
            {
                index = Convert.ToInt32(Console.ReadLine());
            }
        ...
        {
            Console.Write("Letter's UID to COPY : ");
            try
            {
                index = Convert.ToInt32(Console.ReadLine());
            }
            ...
            Console.Write("COPY to which mailbox? : ");
            string parameter = Console.ReadLine();
        ...
        {
            Console.Write("Letter's ID to Fetch flags of : ");
            try
            {
                index = Convert.ToInt32(Console.ReadLine());
            }
        ...
        private void ReceiveResponse(string command)
        {
            try
            {
                ...
                while (bytes != 0)
                {
                    ...
                    Console.WriteLine(answer.Substring(0, bytes));
